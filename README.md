...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a18v0ni.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a18v0ni.containers.anotherwebservice.com/
...
```
git clone git@github.com:hazelcross/container-a18v0ni.git
cd container-a18v0ni
```
...
```
docker attach container-a18v0ni
```
